...
namespace CapaLN
{
    public class PedidosLN
    {
        ...
        public DataSet AlmacenarPedido(PedidosEN pInsumoEN)
        {
            ...
            try
            {
                DataSet ds = ObjAD.AlmacenarPedido(pInsumoEN);
        ...
        public DataSet AlmacenarVale(PedidosEN pInsumoEN)
        {
            DataSet dsResultado = armarDsResultado();
            ...
            try
            {
                DataSet ds = ObjAD.AlmacenarVale(pInsumoEN);
        ...
        public DataSet AlmacenarGasto(PedidosEN pInsumoEN)
        {
            DataSet dsResultado = armarDsResultado();
            ...
            try
            {
                DataSet ds = ObjAD.AlmacenarGasto(pInsumoEN);
        ...
        public DataSet AlmacenarProveedor(ProveedoresEN ObjEN)
        {
            DataSet dsResultado = armarDsResultado();
            ...
            try
            {
                DataSet ds = ObjAD.AlmacenarProveedor(ObjEN);
        ...
        public DataSet AlmacenarAjustePedido(AJUSTE_PEDIDO ObjEN, DataSet dsDetalles)
        {
            DataSet dsResultado = armarDsResultado();
            ...
            try
            {
                DataSet ds = ObjAD.AlmacenarAjustePedido(ObjEN, dsDetalles);
