...
namespace CapaLN
{
    public class PresupuestoLN
    {
        ...
        public int InsertarPresUnidad(PresupuestoEN presupuestoEN)
        {
            presupuestoAD = new PresupuestoAD();
            return presupuestoAD.InsertarPresUnidad(presupuestoEN);
        }

        public DataSet AlmacenarModificacionTechoPpto(PresupuestoEN presupuestoEN)
        {
            ...
            try
            {
                DataSet ds = presupuestoAD.AlmacenarModificacionTechoPpto(presupuestoEN);
        ...
        public int EliminarPresUnidad(PresupuestoEN presupuestoEN)
        {
            presupuestoAD = new PresupuestoAD();
            return presupuestoAD.EliminarPresUnidad(presupuestoEN);
        }
