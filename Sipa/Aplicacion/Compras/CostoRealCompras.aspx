...
<tr>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="16" style="text-align: center;">
                        <asp:Button ID="btnAprobar" runat="server" class="btn btn-primary" OnClick="btnAprobar_Click" Text="Guardar Montos" Width="300px" OnClientClick="javascript:if(!confirm('¿Desea GUARDAR este registro?'))return false" />
                        <asp:Button ID="btnRechazar" runat="server" class="btn btn-default" OnClick="btnRechazar_Click" Text="Rechazar Pedido" Width="300px" OnClientClick="javascript:if(!confirm('¿Desea RECHAZAR este registro?'))return false" />
