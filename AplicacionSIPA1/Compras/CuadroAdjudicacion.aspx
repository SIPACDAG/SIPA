...
<tr>
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="text-align: center;" colspan="16">&nbsp;<asp:Button ID="btnAprobar" runat="server" class="btn btn-success" OnClick="btnAprobar_Click" Text="Guardar Cotización" Width="95%" />
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%"></td>
                </tr>
