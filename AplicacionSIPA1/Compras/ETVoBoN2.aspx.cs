...
{
    public partial class ETVoBoN2 : System.Web.UI.Page
    {
        ...
        protected void validarEstadoAnexo()
        {
            try
            {
                ...
                if (idEstado.Equals("4") || idEstado.Equals("6"))
                {
                    btnAprobar.Visible = btnRechazar.Visible = true;
                    lblError.Text = string.Empty;
                }

                else if (idEstado.Equals("1") || idEstado.Equals("2") || idEstado.Equals("3") || idEstado.Equals("5"))
                {
                    btnAprobar.Visible = btnRechazar.Visible = false;
        ...
        protected void btnAprobar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                pInsumoLN = new PedidosLN();
                DataSet dsResultado = pInsumoLN.AprobarEspecificacion(idEspecificacion, idTipoDocumento, "", 3);
        ...
        protected void btnRechazar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                pInsumoLN = new PedidosLN();
                DataSet dsResultado = pInsumoLN.RechazarEspecificacion(idEspecificacion, idTipoDocumento, "", 4);
