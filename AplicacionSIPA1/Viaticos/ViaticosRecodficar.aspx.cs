...
{
    public partial class ViaticosRecodficar : System.Web.UI.Page
    {
        ...
        protected void filtrarDvPedidos()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (true)
                    {
                        dsResultado = pViaticosLN.InformacionViatico(int.Parse(ddlAnios.SelectedValue), 0, 13);
        ...
        protected void validarEstadoViatico(int idViatico)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (idEstadoViatico == 11 || idEstadoViatico == 12)
                        btnLiquidar.Visible = btnRechazar.Visible = btnAnular.Visible = true;
