            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlDependencia" runat="server" AutoPostBack="True" class="form-control"  Width="100%" OnSelectedIndexChanged="ddlDependencia_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlJefaturaUnidad" runat="server" AutoPostBack="True" class="form-control"  Width="100%" OnSelectedIndexChanged="ddlJefaturaUnidad_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
