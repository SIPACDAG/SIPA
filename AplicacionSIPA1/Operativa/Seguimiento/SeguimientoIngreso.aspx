            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlDependencias" runat="server" AutoPostBack="True" class="form-control"  Width="100%" OnSelectedIndexChanged="ddlDependencias_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlJefaturasUnidades" runat="server" AutoPostBack="True" class="form-control"  Width="100%" OnSelectedIndexChanged="ddlJefaturasUnidades_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
