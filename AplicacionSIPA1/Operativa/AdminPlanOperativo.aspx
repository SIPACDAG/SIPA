<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPlanOperativo.aspx.cs" Inherits="AplicacionSIPA1.Operativa.AdminPlanOperativo" MasterPageFile="~/Principal.Master" %>
            ...
            <asp:UpdatePanel ID="upModificar" runat="server">
                <ContentTemplate>
                    ...
                    <tr>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="font-size: x-large; text-align: center;" colspan="16"><strong>ADMIN - PLAN OPERATIVO</strong></td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
