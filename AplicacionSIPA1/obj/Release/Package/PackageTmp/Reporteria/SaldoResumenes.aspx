<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaldoResumenes.aspx.cs" Inherits="AplicacionSIPA1.Reporteria.SaldoResumenes" MasterPageFile="~/Principal.Master" %>
                            ...
                            <tr>
                                <td colspan="5">
                                    <asp:RadioButtonList ID="rblOpcion" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblOpcion_SelectedIndexChanged" RepeatDirection="Horizontal" Width="817px">
                                        <asp:ListItem Selected="True" Value="1">SaldosUnidad</asp:ListItem>
                                        <asp:ListItem Value="2">Fuente</asp:ListItem>
                                        <asp:ListItem Value="3">TechosAsignados</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                <td>&nbsp;</td>
