<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="saldosUnidadDetalle.aspx.cs" Inherits="AplicacionSIPA1.Reporteria.saldosUnidadDetalle" MasterPageFile="~/Principal.Master" %>
<%@ PreviousPageType VirtualPath="~/Reporteria/SaldosUnidades.aspx" %>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnRegresar" runat="server" class="btn btn-primary" PostBackUrl="~/Reporteria/SaldosUnidades.aspx" Text="Regresar" />
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
