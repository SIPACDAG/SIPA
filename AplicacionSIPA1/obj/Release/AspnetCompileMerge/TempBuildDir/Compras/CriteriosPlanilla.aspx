<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CriteriosPlanilla.aspx.cs" Inherits="AplicacionSIPA1.Compras.CriteriosPlanilla" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>CRITERIOS DE COMPRA PARA REQUISICIONES</strong></td>
...
<tr>
                    ...
                    <td colspan="18" style="text-align: center">
                        <asp:GridView ID="gridDetalle" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID,COSTO_ESTIMADO" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" PageSize="12" ShowFooter="True" Width="100%" Font-Size="Small" OnRowDataBound="gridDetalle_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CANTIDAD ADJUDICADA" Visible="False">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="MONTO INDIVIDUAL ADJUDICADO SIN IVA" Visible="False">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="SUBTOTAL ADJUDICADO SIN IVA" Visible="False">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="NO ORDEN C." Visible="False">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="FECHA ORDEN C." Visible="False">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="PAGO F." Visible="False">
                                    <ItemTemplate>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">
                        <asp:Label ID="lblIdCriterioPedido" runat="server" ForeColor="White">0</asp:Label>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td colspan="5">Base de puntuación para el pedido seleccionado:</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="6">
                        <asp:DropDownList ID="ddlCriterios" runat="server" AutoPostBack="True" BackColor="#FFFF99" class="form-control" Width="100%" OnSelectedIndexChanged="ddlCriterios_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="2">
                        <asp:TextBox ID="txtPuntuacion" runat="server" BackColor="#FFFF99" class="form-control" Enabled="true" Font-Size="Large" MaxLength="5" Style="text-align: right" TextMode="Number" Width="95%"></asp:TextBox>
                    </td>
                    <td colspan="3">
                        <asp:Button ID="btnGuardar" runat="server" class="btn btn-primary" OnClick="btnGuardar_Click" Text="Guardar Criterio" Width="95%" />
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                    ...
                    <td colspan="12">
                        <asp:GridView ID="gridCriterios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID_CRITERIO_PEDIDO" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" Width="100%" OnRowDeleting="gridCriterios_RowDeleting" OnSelectedIndexChanged="gridCriterios_SelectedIndexChanged">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ID_CRITERIO_PEDIDO" HeaderText="ID" Visible="False">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="puntuacion" HeaderText="Base de Puntuación (Pedido)">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                            </Columns>
