<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuadroAdjudicacion.aspx.cs" Inherits="AplicacionSIPA1.Compras.CuadroAdjudicacion" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>CUADRO DE ADJUDICACIÓN DE REQUISICIONES</strong></td>
...
<tr>
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="3">Oferente:</td>
                    <td colspan="12">
                        <asp:DropDownList ID="ddlProveedores" runat="server" AutoPostBack="True" BackColor="#FFFF99" class="form-control" Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    ...
                    <td colspan="18" style="text-align: center">
                        <asp:GridView ID="gridDetalle" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID,COSTO_ESTIMADO" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" PageSize="12" ShowFooter="True" Width="100%" Font-Size="Small" OnRowDataBound="gridDetalle_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CANTIDAD COTIZADA">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="MONTO INDIVIDUAL COTIZADO SIN IVA">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="SUBTOTAL COTIZADO SIN IVA">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="IVA" Visible="False">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Criterio 1">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <div class="text-right">
                                            <asp:TextBox ID="txtCriterio1" Style="text-align: right" runat="server" Width="95px" ReadOnly = "False"></asp:TextBox>
                                            <asp:Label ID="lblErrorC1" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                   <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Criterio 2">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <div class="text-right">
                                            <asp:TextBox ID="txtCriterio2" Style="text-align: right" runat="server" Width="95px" ReadOnly = "False"></asp:TextBox>
                                            <asp:Label ID="lblErrorC2" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                   <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Criterio 3">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <div class="text-right">
                                            <asp:TextBox ID="txtCriterio3" Style="text-align: right" runat="server" Width="95px" ReadOnly = "False"></asp:TextBox>
                                            <asp:Label ID="lblErrorC3" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                   <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                ...
                                <asp:TemplateField HeaderText="Total">
                                    ...
                                    <ItemTemplate>
                                        <div class="text-right">
                                            <asp:TextBox ID="txtCriterioT" Style="text-align: right" runat="server" Width="95px" ReadOnly = "True"></asp:TextBox>
                                            <asp:Label ID="lblErrorCT" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                   <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="text-align: center;" colspan="16">&nbsp;<asp:Button ID="btnAprobar" runat="server" class="btn btn-primary" OnClick="btnAprobar_Click" Text="Guardar Cotización" Width="95%" />
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="12">
                        <asp:GridView ID="gridCriterios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" Width="100%">
                            <AlternatingRowStyle BackColor="#CEEFFF" ForeColor="#333333" />
                            <Columns>
                                ...
                                <asp:BoundField DataField="puntuacion" HeaderText="Base de Puntuación">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                            </Columns>
