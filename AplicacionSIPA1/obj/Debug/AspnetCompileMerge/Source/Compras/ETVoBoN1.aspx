<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ETVoBoN1.aspx.cs" Inherits="AplicacionSIPA1.Compras.ETVoBoN1" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>ESPECIFICACIONES TÉCNICAS<br /> (MESA DE ENTRADA)</strong></td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;" colspan="16">
                        <asp:Button ID="btnAprobar" runat="server" class="btn btn-primary" OnClick="btnAprobar_Click" Text="Aprobar" Width="300px" />
                        <asp:Button ID="btnRechazar" runat="server" class="btn btn-default" OnClick="btnRechazar_Click" Text="Rechazar" Width="300px" />
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
