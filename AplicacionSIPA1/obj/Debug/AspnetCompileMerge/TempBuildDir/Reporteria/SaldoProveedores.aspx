<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaldoProveedores.aspx.cs" Inherits="AplicacionSIPA1.Reporteria.SaldoProveedores" MasterPageFile="~/Principal.Master" %>
                            ...
                            <tr>
                                <td colspan="5">
                                    <asp:RadioButtonList ID="rblOpcion" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblOpcion_SelectedIndexChanged" RepeatDirection="Horizontal" Width="817px">
                                        <asp:ListItem Selected="True" Value="1">Compra a Proveedores</asp:ListItem>
                                        <asp:ListItem Value="2">Descripcion de la Compra</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                <td>&nbsp;</td>
