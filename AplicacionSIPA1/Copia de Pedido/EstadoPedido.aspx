<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadoPedido.aspx.cs" Inherits="AplicacionSIPA1.Pedido.EstadoPedido" MasterPageFile="~/Principal.Master" %>
                    ...
                    <ContentTemplate>
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Button ID="btnModificar" runat="server" BackColor="#FF6600" class="btn btn-primary" Font-Bold="True" Text="MODIFICAR PEDIDO" Visible="False" Width="30%" OnClick="btnModificar_Click" PostBackUrl="~/Pedido/ModificarPedido.aspx" />
                                    <asp:Button ID="btnImprimir" runat="server" BackColor="#3366CC" class="btn btn-primary" Font-Bold="True" Text="IMPRIMIR PEDIDO" Visible="False" Width="32%" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                                ...
                                <td colspan="3">
                                    <asp:GridView ID="gridEstado" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" OnPageIndexChanging="gridEstado_PageIndexChanging" OnSelectedIndexChanged="gridEstado_SelectedIndexChanged" Width="95%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="fechaNOC" DataFormatString="{0:d}" HeaderText="fechaNOC" >
                                            <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:BoundField>
