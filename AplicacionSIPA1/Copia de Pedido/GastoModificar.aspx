<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GastoModificar.aspx.cs" Inherits="AplicacionSIPA1.Pedido.GastoModificar" MasterPageFile="~/Principal.Master" %>
                       ...
                       <ContentTemplate>
                           <table style="width:80%;">
                            <tr>
                               ...
                               <tr>
                                   <td class="auto-style18" colspan="4"><strong>Modificar Gasto No.
                                       <asp:Label ID="lblidGasto" runat="server"></asp:Label>
                                       </strong></td>
                               </tr>
                               <tr>
                            ...
                            <tr>
                               ...
                               <tr>
                                   <td class="auto-style3">Gasto A:</td>
                                   <td class="auto-style4">
                               ...
                               <tr>
                                   <td class="auto-style3">Justificacion/Motivo<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtJustificacion" ErrorMessage="*" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationGroup="vacios"></asp:RequiredFieldValidator>
                                   </td>
                                   <td class="auto-style4">
