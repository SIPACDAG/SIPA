...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <br />
    <br />
    <%--<rsweb:ReportViewer ID="report2" runat="server" Font-Names ="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size ="14pt" Width="1311px" Height="528px" Style="margin-top: 0px">
        <LocalReport ReportPath="ReporteriaSistemas\Report1.rdlc">
            <DataSources>
