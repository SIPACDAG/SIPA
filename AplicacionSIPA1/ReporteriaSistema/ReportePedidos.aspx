...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   ...
   <asp:Label runat="server" ID="lblIdPoa"  Visible="false"/>
    ...
    <div class="col-md-2">
        <asp:label ID="lblTecho" runat="server" Text="Presupuesto"></asp:label>
        <asp:Label ID="lblTechoU" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Blue" Text="0.00"></asp:Label>
    </div>
    <div class="col-md-2">
         <asp:label ID="lblDisponible" runat="server" Text="Codificado"></asp:label>
        <asp:Label ID="lblDisponibleU" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red" Text="0.00"></asp:Label>
    </div>
    <div class="col-md-2">
         <asp:label ID="lblSaldo" runat="server" Text="Disponible"></asp:label>
        <asp:Label ID="lblSaldoU" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Green" Text="0.00"></asp:Label>
    </div>
    <br />
        <br />
        <br />
