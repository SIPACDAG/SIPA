        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtCantidadMultianual" runat="server" BackColor="#FFFF99" class="form-control" Font-Size="Large" MaxLength="10" Style="text-align: right" Width="100%"></asp:TextBox>
                    </td>
                    <td colspan="4">
                        <asp:TextBox ID="txtCostoMultianual" runat="server" BackColor="#FFFF99" class="form-control" Font-Size="Large" MaxLength="12" Style="text-align: right" Width="100%"></asp:TextBox>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
