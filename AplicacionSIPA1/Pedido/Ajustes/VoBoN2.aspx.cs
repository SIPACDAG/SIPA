                    ...
                    if (true)
                    {
                        ...
                        if (true)
                        {
                            ...
                            else
                            {
                                ...
                                dsResultado = pInsumoLN.RechazoPresupuestoAjuste(idAjustePedido, 0, txtObser.Text, Session["usuario"].ToString());
                ...
                if (validarControlesABC())
                {
                    if (validarEstadoPedido(idPedido))
                    {
                        if (validarEstadoAjuste(idAjustePedido))
                        {
                            ...
                            dsResultado = pInsumoLN.AprobacionPresupuestoAjuste(idAjustePedido, 0, "", Session["usuario"].ToString());
