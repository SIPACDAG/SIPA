<%@  Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarPedido.aspx.cs" Inherits="AplicacionSIPA1.Pedido.ModificarPedido"   MasterPageFile="~/Principal.Master" %>
<%@ PreviousPageType VirtualPath="~/Pedido/EstadoPedido.aspx" %>
                       ...
                       <ContentTemplate>
                           <table style="width:80%;">
                            <tr>
                               ...
                               <tr>
                                   <td class="auto-style18" colspan="4"><strong>Modificar Pedido No.</strong><asp:Label ID="lblidPedido" runat="server"></asp:Label>
                                   </td>
                               </tr>
                               <tr>
                                   <td class="auto-style3" colspan="4"><strong><span class="auto-style19">Acci<span>ó</span>n</span></strong><asp:DropDownList ID="dropAccion" runat="server" class="form-control" Width="99%" AutoPostBack="True" Enabled="False">
                                       </asp:DropDownList>
                                   </td>
                               </tr>
                            <tr>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style4">
                                       <asp:DropDownList ID="dropTipoGasto" runat="server" class="form-control" Width="98%" AutoPostBack="True" OnSelectedIndexChanged="dropTipoGasto_SelectedIndexChanged">
                                       </asp:DropDownList>
                                   </td>
                                   <td class="auto-style12">FADN</td>
                                   <td>
                                       <asp:DropDownList ID="dropFand" runat="server" class="form-control" Width="98%" Enabled="False">
                                       </asp:DropDownList>
                                   </td>
                               </tr>
                               <tr>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style4">
                                       <asp:DropDownList ID="dropTipoPedido" runat="server" class="form-control" Width="98%" AutoPostBack="True" OnSelectedIndexChanged="dropTipoPedido_SelectedIndexChanged" Enabled="False">
                                       </asp:DropDownList>
                                   </td>
                                   <td class="auto-style12">&nbsp;</td>
                                   <td>&nbsp;</td>
