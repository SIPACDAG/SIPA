<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IngresarPac.aspx.cs" Inherits="AplicacionSIPA1.PacInsumos.IngresarPac" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="width: 5%">
                        &nbsp;</td>
                    <td colspan="16" style="font-size: x-large; text-align: center"><strong>BUSQUEDA DE INSUMOS</strong></td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="15"><strong>
                        <asp:Label ID="lblNoRenglon" runat="server" Text="S/R"></asp:Label>
                        </strong></td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <asp:Button ID="btnBuscarInsumo" runat="server" CausesValidation="False" class="btn btn-primary" OnClick="btnBuscarInsumo_Click" Text="Buscar" Width="120px" />
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="18" style="font-size: large"><strong>Pac No.:
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="17">
                        <asp:DropDownList ID="ddlPac" runat="server" AutoPostBack="True" class="form-control" Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td><span>
                        <asp:Button ID="btnAgregarInsumo" runat="server" CausesValidation="False" class="btn btn-default" ForeColor="White" Text="+" Width="100%" OnClick="btnAgregarInsumo_Click" ToolTip="Agregar un insumo" />
                        </span></td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                   ...
                   <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td colspan="18" style="text-align: center">
                                    ...
                                    <asp:Button ID="btnModificar" runat="server" BackColor="#FF6600" class="btn btn-primary" Font-Bold="True" OnClick="btnModificar_Click" Text="Modificar" Visible="False" Width="120px" />
                                </td>
                                <td style="width: 5%">&nbsp;</td>
                            </tr>
                            <tr>
